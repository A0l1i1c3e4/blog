  ...
  .then(data => {
    ...
    admins.forEach(administrator => {
      ...
      if(administrator.gender=="Male")        {
        adminblock.querySelector('img').src = 'https://sun9-80.userapi.com/impg/ABAM2rjROlJJKMK5fNiiKxoLtroQKf2K49-Hwg/Di0hQkgh318.jpg?size=387x387&quality=95&sign=4e3618501c6833a9798a101cb313e3d5&type=album';
      }
      else {
        adminblock.querySelector('img').src = 'https://sun9-80.userapi.com/impg/msquQVKiPuvj-EEPAo3v1-rj4kptEnmZYVJ24Q/86f_6d-bfFM.jpg?size=386x383&quality=95&sign=ef97469c6ae92fbca9d459007d3bfa75&type=album';
      }
...
function makePost(){
  window.location.href = 'file:///E:/TSU/Front/lab2/createpost/creater.html';
}
